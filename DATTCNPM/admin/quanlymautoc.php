    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <a href="index.php" class="list-group-item list-group-item-action bg-transparent second-text "><i
                ...
                <a href="quanlymautoc.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Quản Lý Kiểu Tóc</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                ...
                <div    class="row my-5">
                    <ul class="quanly" style="padding-bottom: 60px;">
                    <li><a href="themmautoc.php" class="btn__add" style="padding: 15px 50px; background-color: #f18a1c; border-radius: 4px; text-align: center;padding-top: 8px; color: #fff; font-size: 18px; font-weight: 600;">
                            Thêm mới
                        </a></li>
                        <li><form method="POST" class="d-flex" action="">
                            <input name="search" hidden type="search" class="form-control" style="border-color: #000;height: 40px; width: 300px; position: relative;">
                            <button name="sbm" hidden class="btn btn-success" style=" border-color: #f18a1c; border: unset; margin-top: 0px; padding: 8px 10px;">Tìm kiếm</button>
                        </form>
                    </li>
                    </ul>
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                <tr style="text-align: center;">
                                    ...
                                    <th scope="col" style="width: 30%;">Bài Viết</th>
                            ...
                            <?php
                                ...
                                $totalRecords = mysqli_query($conn, "SELECT * FROM `mautoc`");
                                ...
                                $result = mysqli_query($conn, "SELECT * FROM `mautoc` LIMIT $start, $limit");
                                while ($row = mysqli_fetch_array($result)){
                            ?>
                                <tr style="text-align: center;">
                                    <th scope="row"><?php echo $i++ ?></th>
                                    <td style="height:150px; width: 150px;"><img style="height: 160px; width: 150px;"src="../img/kieutoc/<?php echo $row['img']?>" alt=""></td>
                                    <td><?php echo $row['title']?></td>
                                    <td><?php echo $row['link_content']?></td>
                                    <td>
                                        <a class="btn btn-warning" style=" line-height: 40px; padding: 0px 20px; background-color:#ffc107; border-radius: 3px" href="suamautoc.php?id=<?php echo $row['id']?>">Sửa</a>
                                        <a class="btn btn-danger" style="line-height: 40px; padding: 0px 20px; background-color:#dc3545; border-radius: 0.25rem;" href="xoamautoc.php?id=<?php echo $row['id']?>">Xóa</a>
                                    </td>  
                                </tr>
                            <?php }?>
                            </tbody>
                ...
                <?php for ($i = 1; $i <= $total_page; $i++){
                    ...
                    if ($i == $current_page){
                        ...
                        echo '<li class="pag-item"><a href = "quanlymautoc.php?page='.$i.'">'.$i.'</a></li>';
                    }
                    }?>
                    </ul>
                    </div>
