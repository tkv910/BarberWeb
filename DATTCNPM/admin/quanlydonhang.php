...
<?php
    ...
    if(isset($_POST['sbm']) && !empty($_POST['search'])){
        $search = $_POST['search'];
        $sql = "SELECT * FROM donhang WHERE tenkh LIKE '%$search%'";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <a href="index.php" class="list-group-item list-group-item-action bg-transparent second-text "><i
                ...
                <a href="quanlydonhang.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div    class="row my-5">
                    <ul class="quanly">
                    <li><a href="themdonhang.php" class="btn__add" style="padding: 15px 50px; background-color: #f18a1c; border-radius: 4px; text-align: center;padding-top: 8px; color: #fff; font-size: 18px; font-weight: 600;">
                            Thêm mới
                        </a></li>
                        <?php
                if(isset($total_prd)){
