    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <a href="index.php" class="list-group-item list-group-item-action bg-transparent second-text "><i
                ...
                <a href="quanlynhanvien.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Quản Lý Khách Hàng</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                ...
                <div    class="row my-5">
                    <ul class="quanly">
                    <li><a href="themnhanvien.php" class="btn__add" style="padding: 15px 50px; background-color: #f18a1c; border-radius: 4px; text-align: center;padding-top: 8px; color: #fff; font-size: 18px; font-weight: 600;">
                            Thêm mới
                        </a></li>
                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <?php
                                include '../config.php';
                                $result=mysqli_query($conn, "SELECT * FROM `khachhang` where type = 'admin'");
                                $row = mysqli_fetch_assoc($result);
                                $totalRecords = mysqli_query($conn, "SELECT * FROM `khachhang` where type = 'admin'");
                                ...
                                $result = mysqli_query($conn, "SELECT * FROM `khachhang` where type = 'admin' LIMIT $start, $limit");
