...
<?php
    ...
    if(isset($_POST['sbm']) && !empty($_POST['search'])){
        $search = $_POST['search'];
        $sql = "SELECT * FROM `lichhen` WHERE name LIKE '%$search%'";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <a href="index.php" class="list-group-item list-group-item-action bg-transparent second-text "><i
                ...
                <a href="quanlylichhen.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0" >Quản Lý Lịch Hẹn</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                ...
                <div    class="row my-5">
                    <ul class="quanly">
                    <li><a href="themlichhen.php" class="btn__add" style="padding: 15px 50px; background-color: #f18a1c; border-radius: 4px; text-align: center;padding-top: 8px; color: #fff; font-size: 18px; font-weight: 600;">
                            Thêm mới
                        </a></li>
                        ...
                        <?php
                            if(isset($total_prd)){
                                if($total_prd !==0){
                                    ...
                                    echo "<p class='text-danger'> Không tìm thấy lịch hẹn! </p>";
                                }
                            }
                        ?>
                    ...
                    <?php
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" style=" line-height: 40px; padding: 0px 20px; background-color:#ffc107; border-radius: 3px" href="sualichhen.php?id_lh=<?php echo $row['id_lh']?>">Sửa</a>
                                        <a class="btn btn-danger" style="line-height: 40px; padding: 0px 20px; background-color:#dc3545; border-radius: 0.25rem;" href="xoalichhen.php?id_lh=<?php echo $row['id_lh']?>">Xóa</a>
                                    </td>  
                                </tr>
                            <?php }?>
                            </tbody>
                        ...
                        <?php  if(empty($_POST['search'])){?>
                            ...
                            <?php
                                include '../config.php';
                                $result=mysqli_query($conn, "SELECT * FROM `lichhen`");
                                $row = mysqli_fetch_assoc($result);
                                $totalRecords = mysqli_query($conn, "SELECT * FROM `lichhen`");
                                ...
                                $result = mysqli_query($conn, "SELECT * FROM lichhen LIMIT $start, $limit");
